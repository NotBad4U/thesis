...
(assume a1 (forall ((?v0 S4) (?v1 S3)) 
    (= 
        (f63 (f80 f81 ?v0) ?v1) 
        (ite (exists ((?v0 S4)) (and (= (f5 ?v1 ?v0) f1) (forall ((?v3 S4)) (=> (= (f5 ?v1 ?v3) f1) (= ?v3 ?v0))))) (f63 f72 ?v1) ?v0)
    )
))
(assume a2 (forall ((x S1) (y S1)) (= x y)))
(step t0 (cl 
    (not (! (= (! (=> (forall ((x S1) (y S1)) (= x y)) (! (= f2 f1) :named @p_4)) :named @p_5) 
    (! (=> (forall ((x S1) (y S1)) (= x y)) @p_1) :named @p_3)) :named @p_6)) 
    (not @p_5) @p_3) :rule equiv_pos2
)
(step t1 (cl (= (forall ((x S1) (y S1)) (= x y)) (forall ((x S1) (y S1)) (= x y)))) :rule refl)
...
(step t5.t0 (cl (or (! (not (forall ((x S1) (y S1)) (= x y))) :named @p_2) @p_4)) :rule forall_inst :args (f2 f1))
(step t5.t1 (cl @p_2 @p_4) :rule or :premises (t5.t0))
(step t5.t2 (cl @p_4) :rule resolution :premises (t5.t1 t5.a0) :args ((forall ((x S1) (y S1)) (= x y)) false))
(step t5 (cl @p_2 @p_4) :rule subproof :discharge (t5.a0))
(step t6 (cl @p_5 @p_4) :rule resolution :premises (t4 t5) :args ((forall ((x S1) (y S1)) (= x y)) true))
...
(step t10 (cl @p_3) :rule resolution :premises (t0 t3 t9) :args (@p_6 false @p_5 false))
(step t11 (cl @p_2 @p_1) :rule implies :premises (t10))
(step t12 (cl @p_1 @p_2) :rule reordering :premises (t11))
(step t13 (cl) :rule resolution :premises (t12 a2 a0) :args ((forall ((x S1) (y S1)) (= x y)) false @p_1 true))