...
that represents the set of natural numbers less than an arbitrary $w$. We use a dependent pair type (\cref{dep-pair-def}) in Lambdapi necessary to encode \kw{Fin} using an inductive encoding.
