...
\begin{tabular}{l}
  ...
  $\quad (hps : \prfcl ps)$ \\ 
  $\quad (hqs : \prfcl qs)$ \\ 
  $\quad (hi  : \prf(i < \tt{size}\; ps))$ \\ 
  $\quad (hj  : \prf(j < \tt{size}\; qs))$ \\ 
  $\quad (hij : \prf((\tt{nth}\; ps\; i) = \lnot(\tt{nth}\; qs\; j)))$ \\
  $\qquad : \prfcl(\tt{remove}\; ps\; i \mathrel{\pp} \tt{remove}\; qs\; j)$
\end{tabular}
