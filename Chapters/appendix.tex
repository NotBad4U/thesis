...
The \cref{tab:all-benchmarks} summarizes, for each benchmark group, how many unsatisfiable instances are solved by \texttt{cvc5}
and how many of the resulting proofs can be elaborated by Carcara. Over all groups, \texttt{cvc5} produces a proof for 17 53917\,53917539
out of the 20,36220\,36220362 unsat instances considered, with only 888 outright failures and 2 8152\,8152815 timeouts.
Carcara then successfully elaborates 17 13517\,13517135 of these proofs, that is about 97.7\%97.7\%97.7\%
of the proofs generated by \texttt{cvc5} that reach the elaboration phase, while 645645645 proofs fail to elaborate and only 555 time out.
This indicates that, once \texttt{cvc5} is able to find a proof and it can be translated to Lambdapi, our pipeline is highly robust: the vast majority of proofs can be reconstructed and checked by Carcara, and the elaboration step introduces very few additional failures or timeouts.
...
\pgfplotstabletypeset[
  ...
  columns/logic/.style={string type, column name={logic}},
    columns/cvc5_count/.style={column name={number of problems}},
...
\end{axis}
\end{tikzpicture}
\caption{Lambdapi translation times for large problems.}
