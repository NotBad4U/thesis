...
\begin{tabular}{|lll|}
\hline
\kw{arith-elim-gt} & \kw{arith-elim-leq} & \kw{arith-geq-norm1} \\
\kw{arith-geq-norm2} & \kw{arith-geq-tighten} & \kw{arith-int-eq-elim} \\
\kw{arith-leq-norm} & \kw{arith-poly-norm} & \kw{arith-refl-geq} \\
\kw{arith-refl-leq} & \kw{arith-refl-lt} & \kw{comp\_simplify} \\
\kw{evaluate} & \kw{la\_disequality} & \kw{la\_generic} \\
\kw{la\_rw\_eq} & \kw{la\_totality} & \kw{lia\_generic} \\
\hline
\end{tabular}
