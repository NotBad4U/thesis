...
\lstinputlisting[language=SMT]{Assets/app_ex.smt2}

\lstinputlisting[language=SMT]{Assets/app_ex.alethe}

\lstinputlisting[language=Lambdapi, mathescape=true]{Assets/app_ex.lp}