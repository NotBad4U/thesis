...
\begin{lstlisting}[language=SMT,caption={[Running example and Alethe proof]Running example: an SMT problem and its Alethe proof found by cvc5.},label={lst:smtexampleinput-fol}]
(assume a0 (p a))
(assume a1 (= a b))
(assume a2 (not (p b)))
