...
We will use the input problem shown in the top part of \cref{lst:smtexampleinput-fol} with its Alethe proof (found by cvc5) in the bottom part as a running example to provide an overview of Alethe concepts and to illustrate our embedding in Lambdapi.
...
We will use the input problem shown in \cref{lst:smtexampleinput-lia} with its Alethe proof (found by cvc5) in \cref{lst:smtexampleproof} as a running example to introduce Alethe concepts and illustrate our reconstruction of linear arithmetic step in Lambdapi.
