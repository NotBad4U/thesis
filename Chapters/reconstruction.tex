...
\end{align*}
The auxiliaries functions \( \mathop{\mathrm{div2}} : \mathbb{N} \ra \mathbb{N} \) and the boolean \( \mathop{\mathrm{and}} : \B \ra \B \ra \B \) are defined recursively as:
\begin{align*}
&\mathop{\mathrm{div2}}\,0 \re 0 \\
&\mathop{\mathrm{div2}}\,1 \re 0 \\
&\mathop{\mathrm{div2}}\,x{+}2 \re \mathop{\mathrm{div2}}\,x + 1 \\
&\\
&\mathop{\mathrm{and}}(\mathrm{true},\, b) \re b \\
&\mathop{\mathrm{and}}(b,\, \mathrm{true}) \re b \\
&\mathop{\mathrm{and}}(\mathrm{false},\, \_) \re \mathrm{false} \\
&\mathop{\mathrm{and}}(\_,\, \mathrm{false}) \re \mathrm{false}
\end{align*}
Then, we can define the natural number bolean and i.e. (\&\&) as:
\begin{equation*}
\&\&~(a\,b: \N): \N \is \mathop{bitwise}\,(and)\,a\,a\,b \quad \text{(written infix)}
\end{equation*}
\end{definition}
