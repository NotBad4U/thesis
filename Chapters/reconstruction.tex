%*****************************************
\chapter{Reconstructing SMT Proofs Formally}\label{ch:reconstruction}
%*****************************************
...
% and how we extended Carcara with a new module that can export elaborated Alethe proofs to Lambdapi. 
Our work applies to input problems expressed in the logics \texttt{UFLIA}, \texttt{UFNIA} or their sub-logics.
...
\begin{align*}
&\index{\set}: \type & &\index{\prop}: \type \\
&\index{\el}: \set \rightarrow \type  & &\index{\prf} : \prop \rightarrow \type \\
...
& \epsilon_i: \Pi {[a: \set]}, \Pi (x : \el\,a), \Pi (P : \el\,a \ra \prop) \ra \pic P\,x \ra \pic P\,(\epsilon\,P) \\
& \epsilon_{d}: \Pi {[a: \set]}, \Pi (P\,Q : \el\,a \ra \prop) \ra \Pi x : \el\,a, \pic (P\,x = Q\,x) \ra (\epsilon \, P = \epsilon \, Q)
\end{align*}
