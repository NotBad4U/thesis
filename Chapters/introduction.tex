...
\ac{SMT} solvers \cite{cvc5,verit} are \ac{AR} tools that have become especially essential in a wide range of formal reasoning tasks, including program verification and interactive theorem proving.
