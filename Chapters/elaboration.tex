...
\begin{figure}
  ...
  \begin{tabular}{c}
    ...
    \end{prooftree}
  \end{tabular}
  \caption[Resolution-step elaboration]{A resolution step before and after elaboration.}
...
\subsection{Elaboration of \kw{lia\_generic} steps}
...
Carcara treats \tt{lia\_generic} steps as proof holes, since ``their checking is as hard as solving''~\cite[\S 3.2]{carcara}.
...
\begin{lstlisting}[language=SMT,caption={Elaboration of \kw{lia\_generic}},label={lst:elab_lia}]
(anchor :step S.t_m+1)
(assume S.h_1 l1)
...
(assume S.h_n ln)
...
\end{tikzpicture}
\caption[Overview of the approach]{Overview of the components of our approach}
