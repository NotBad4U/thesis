...
This rule specifies symmetry of equality. This rule takes as premise an equality \smtinline{(= t s)} and no arguments.
...
The Eunoia proof format follows a structure that is almost identical to that of Alethe (\smtinline{assume}, \smtinline{step}).
...
The proof begins line 9 by assuming the equality of \tt{a} and \tt{b}, labeled as \smtinline{@p0}.
Finally, at line 10, the symmetry rule \tt{symm} is applied to derive the equality of \tt{b} and \tt{a}, labeled as \smtinline{@p1}, using the assumption \smtinline{@p0} as the premise.
