...
\DeclareFontShape{T1}{pplj}{b}{sc}{<->ssub * pplj/m/sc}{}
\DeclareFontShape{T1}{pplj}{m}{scit}{<->ssub * pplj/m/sc}{}
\DeclareFontShape{T1}{pplj}{b}{scit}{<->ssub * pplj/m/sc}{}
...
% % rgb(79, 23, 135)
% \definecolor{purpledark}{RGB}{79, 23, 135}
...
% rgb(141,31,137)
\definecolor{rxpurple2}{RGB}{141,31,137}
% rgb(4,38,137)
...
\DeclareUnicodeCharacter{03C4}{\textcolor{RoyalBlue}{\texttt{El}}}
...
\newcommand{\grNT}[1]{\textcolor{Emerald}{\langle\texttt{#1}\rangle}}
\newcommand{\grT}[1]{\textcolor{RoyalBlue}{\texttt{#1}}}
\newcommand{\grRule}{=}
\newcommand{\grOr}{|}
\newcommand{\concat}{~+\!\!\!+~}
...
\newcommand\lp{\ensuremath{\lambda\Pi}}
\newcommand\pre{\Sigma_{pre}}
\newcommand\prf{\textcolor{rxpurple}{\texttt{\upshape{Prf}}}}
\newcommand\prfcl{\prf\textcolor{rxpurple}{\smash{^\bullet}}}
...
\newcommand\cltodisj[0]{\kw{cl2disj}}

\newcommand\tlist[1]{\kw{list}~\texttt{#1}}
\newcommand\List[1]{\bb{L}~\texttt{#1}}
...
\newcommand\textAlethe[1]{\textcolor{BrickRed}{\texttt{#1}}}
\newcommand\cdclt{CDCL($\cal{T}$)}
...
%******************************************************************
% Acronyms (global definitions)
%******************************************************************
\acrodef{SMT}{Satisfiability Modulo Theories}
\acrodef{ATP}{Automated Theorem Proving}
\acrodef{AR}{Automated Reasoning}
\acrodef{SAT}{Boolean Satisfiability Problem}
\acrodef{AC}{Associative Commutative}

%******************************************************************
% Critical pairs
%******************************************************************

\newcommand\cp[6][\linewidth]{
\begin{minipage}[c]{#1}
% \centering
\begin{tikzpicture}[scale=.9, node distance=2em]
\node[scale=.9] (root) { $\overline{#2}$ };
\node[scale=.9] (left) at ($(root.south) + (-3,-2)$) {$#3$};
\node[scale=.9] (right) at ($(root.south) + (3,-2)$) {$#4$};
...
\newcommand\pipe{\ensuremath{\mathrel{|}}}
