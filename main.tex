...
\newcommandx{\change}[3][1=]{%
  \todo[#1, linecolor=blue, backgroundcolor=blue!25, bordercolor=blue]{\textbf{#2:} #3}%
}

\newcommandx{\question}[3][1=]{%
  \todo[#1, linecolor=orange,backgroundcolor=orange!25,bordercolor=orange]{\textbf{#2:} #3}%
}

\newcommandx{\info}[3][1=]{%
  \todo[#1, linecolor=OliveGreen,backgroundcolor=OliveGreen!25,bordercolor=OliveGreen]{\textbf{#2:} #3}%
}

\newcommandx{\improvement}[3][1=]{%
  \todo[#1, linecolor=Plum,backgroundcolor=Plum!25,bordercolor=Plum]{\textbf{#2:} #3}%
}
...
\newcommandx{\unsure}[3][1=]{%
  \todo[#1,linecolor=red,backgroundcolor=red!25,bordercolor=red]{\textbf{#2:} #3}%
}
