...
% ****************************************************************************************************
\newcommand{\myTitle}{Reconstructing SMT Proofs in Lambdapi\xspace} % From SMT Solvers to Proof Assistants: A Verified Reconstruction Pipeline
\newcommand{\mySubtitle}{Checking and Exporting SMT Proofs using Lambdapi\xspace}
...
\newcommand{\myFaculty}{PhD Thesis in Computer Science\xspace}
...
\AtBeginDocument{\DeclareFontShape{T1}{fvm}{m}{sc}{<->ssub*fvm/m/n}{}} % fix missing small caps for mono font
